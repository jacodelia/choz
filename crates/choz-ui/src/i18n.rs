...
static TABLE: &[Row] = &[
    ...
    ("PROGRESSION",  ["PROGRESI\u{d3}N", "PROGRESS\u{c3}O",  "GRILLE",       "GIRO",         "AKKORDFOLGE",  "\u{421}\u{415}\u{422}\u{41a}\u{410}", "\u{30b3}\u{30fc}\u{30c9}\u{9032}\u{884c}", "\u{548c}\u{5f26}\u{8fdb}\u{884c}"]),
    ("SAVE",         ["GUARDAR",     "SALVAR",       "ENREGISTRER",  "SALVA",        "SPEICHERN",    "\u{421}\u{41e}\u{425}\u{420}\u{410}\u{41d}\u{418}\u{422}\u{42c}", "\u{4fdd}\u{5b58}", "\u{4fdd}\u{5b58}"]),
    ("MAP",          ["MAPA",        "MAPA",         "CARTE",        "MAPPA",        "MAPPING",      "\u{41a}\u{410}\u{420}\u{422}\u{410}", "\u{30de}\u{30c3}\u{30d7}", "\u{6620}\u{5c04}"]),
    ("COLUMN",       ["COLUMNA",     "COLUNA",       "COLONNE",      "COLONNA",      "SPALTE",       "\u{421}\u{422}\u{41e}\u{41b}\u{411}\u{415}\u{426}", "\u{5217}", "\u{5217}"]),
    ("SAMPLER",      ["SAMPLER",     "SAMPLER",      "SAMPLER",      "SAMPLER",      "SAMPLER",      "\u{421}\u{415}\u{41c}\u{41f}\u{41b}\u{415}\u{420}", "\u{30b5}\u{30f3}\u{30d7}\u{30e9}\u{30fc}", "\u{91c7}\u{6837}\u{5668}"]),
    ("NOTE",         ["NOTA",        "NOTA",         "NOTE",         "NOTA",         "NOTE",         "\u{41d}\u{41e}\u{422}\u{410}", "\u{97f3}\u{7b26}", "\u{97f3}\u{7b26}"]),
    ("PIECES",       ["PARTES",      "PARTES",       "MORCEAUX",     "PEZZI",        "TEILE",        "\u{427}\u{410}\u{421}\u{422}\u{415}\u{419}", "\u{5206}\u{5272}", "\u{7247}\u{6bb5}"]),
    ("ARTICULATION", ["ARTICULACI\u{d3}N", "ARTICULA\u{c7}\u{c3}O", "ARTICULATION", "ARTICOLAZIONE", "ARTIKULATION", "\u{410}\u{420}\u{422}\u{418}\u{41a}\u{423}\u{41b}\u{42f}\u{426}\u{418}\u{42f}", "\u{5968}\u{6cd5}", "\u{6f14}\u{594f}\u{6cd5}"]),
    ("VELOCITY",     ["DIN\u{c1}MICA",  "DIN\u{c2}MICA",   "V\u{c9}LOCIT\u{c9}",   "DINAMICA",     "ANSCHLAG",     "\u{421}\u{418}\u{41b}\u{410}", "\u{30d9}\u{30ed}\u{30b7}\u{30c6}\u{30a3}", "\u{529b}\u{5ea6}"]),
    ...
    ("ADD AS THE R SIDE", ["A\u{d1}ADIR COMO LADO R", "ADICIONAR COMO LADO R", "AJOUTER COMME C\u{d4}T\u{c9} R", "AGGIUNGI COME LATO R", "ALS R-SEITE HINZUF\u{dc}GEN", "\u{414}\u{41e}\u{411}\u{410}\u{412}\u{418}\u{422}\u{42c} \u{41a}\u{410}\u{41a} \u{41f}\u{420}\u{410}\u{412}\u{42b}\u{419}", "R\u{30c1}\u{30e3}\u{30f3}\u{30cd}\u{30eb}\u{3068}\u{3057}\u{3066}\u{8ffd}\u{52a0}", "\u{6dfb}\u{52a0}\u{4e3a}\u{53f3}\u{58f0}\u{9053}"]),
    ...
    ("FOLLOW ARR", ["SEGUIR ARR", "SEGUIR ARR", "SUIVRE ARR", "SEGUI ARR", "ARR FOLGEN", "\u{421}\u{41b}\u{415}\u{414}\u{41e}\u{412}\u{410}\u{422}\u{42c} ARR", "ARR\u{306b}\u{8ffd}\u{5f93}", "\u{8ddf}\u{968f} ARR"]),
    ("OPEN", ["ABRIR", "ABRIR", "OUVRIR", "APRI", "\u{d6}FFNEN", "\u{41e}\u{422}\u{41a}\u{420}\u{42b}\u{422}\u{42c}", "\u{958b}\u{304f}", "\u{6253}\u{5f00}"]),
    ...
    ("SPLIT OUT", ["SALIDAS SEP.", "SA\u{cd}DAS SEP.", "SORTIES S\u{c9}P.", "USCITE SEP.", "EINZELAUSG.", "\u{420}\u{410}\u{417}\u{414}. \u{412}\u{42b}\u{425}\u{41e}\u{414}\u{42b}", "\u{500b}\u{5225}\u{51fa}\u{529b}", "\u{72ec}\u{7acb}\u{8f93}\u{51fa}"]),
    ...
    ("  click a key to hear it \u{2014} blue keys have samples, SELECT keeps it", ["  clic en una tecla para o\u{ed}rla \u{2014} las azules tienen samples, SELECT la guarda", "  clique numa tecla para ouvi-la \u{2014} as azuis t\u{ea}m samples, SELECT a mant\u{e9}m", "  cliquez sur une touche pour l'\u{e9}couter \u{2014} les bleues ont des samples, SELECT la garde", "  clicca un tasto per ascoltarlo \u{2014} i blu hanno campioni, SELECT lo tiene", "  eine Taste anklicken, um sie zu h\u{f6}ren \u{2014} blaue haben Samples, SELECT beh\u{e4}lt sie", "  \u{449}\u{451}\u{43b}\u{43a}\u{43d}\u{438}\u{442}\u{435} \u{43a}\u{43b}\u{430}\u{432}\u{438}\u{448}\u{443}, \u{447}\u{442}\u{43e}\u{431}\u{44b} \u{443}\u{441}\u{43b}\u{44b}\u{448}\u{430}\u{442}\u{44c} \u{2014} \u{441}\u{438}\u{43d}\u{438}\u{435} \u{438}\u{43c}\u{435}\u{44e}\u{442} \u{441}\u{44d}\u{43c}\u{43f}\u{43b}\u{44b}, SELECT \u{441}\u{43e}\u{445}\u{440}\u{430}\u{43d}\u{44f}\u{435}\u{442}", "  \u{9375}\u{76e4}\u{3092}\u{30af}\u{30ea}\u{30c3}\u{30af}\u{3057}\u{3066}\u{8a66}\u{8074} \u{2014} \u{9752}\u{3044}\u{9375}\u{76e4}\u{306b}\u{30b5}\u{30f3}\u{30d7}\u{30eb}\u{3042}\u{308a}\u{3001}SELECT \u{3067}\u{6c7a}\u{5b9a}", "  \u{70b9}\u{51fb}\u{7434}\u{952e}\u{8bd5}\u{542c} \u{2014} \u{84dd}\u{8272}\u{7434}\u{952e}\u{6709}\u{91c7}\u{6837}\u{ff0c}SELECT \u{4fdd}\u{7559}"]),
    ...
    // says about the progression it read.
    ("ARR", ["ARR", "ARR", "ARR", "ARR", "ARR", "\u{410}\u{420}\u{410}\u{41d}\u{416}", "\u{30a2}\u{30ec}\u{30f3}\u{30b8}", "\u{7f16}\u{66f2}"]),
    ("BAR", ["COMP\u{c1}S", "COMPASSO", "MESURE", "BATTUTA", "TAKT", "\u{422}\u{410}\u{41a}\u{422}", "\u{5c0f}\u{7bc0}", "\u{5c0f}\u{8282}"]),
    // The chart grid: the buttons a progression is edited with now that nothing
    // is typed into it.
    ("CHANGE", ["CAMBIAR", "MUDAR", "CHANGER", "CAMBIA", "\u{c4}NDERN", "\u{418}\u{417}\u{41c}\u{415}\u{41d}\u{418}\u{422}\u{42c}", "\u{5909}\u{66f4}", "\u{4fee}\u{6539}"]),
    ("ROOT", ["FUNDAMENTAL", "FUNDAMENTAL", "FONDAMENTALE", "FONDAMENTALE", "GRUNDTON", "\u{41e}\u{421}\u{41d}\u{41e}\u{412}\u{410}", "\u{30eb}\u{30fc}\u{30c8}", "\u{6839}\u{97f3}"]),
    ("GROUP", ["AGRUPAR", "AGRUPAR", "GROUPER", "RAGGRUPPA", "GRUPPIEREN", "\u{413}\u{420}\u{423}\u{41f}\u{41f}\u{410}", "\u{30b0}\u{30eb}\u{30fc}\u{30d7}", "\u{5206}\u{7ec4}"]),
    ("HOLD", ["MANTENER", "MANTER", "TENIR", "TIENI", "HALTEN", "\u{414}\u{415}\u{420}\u{416}\u{410}\u{422}\u{42c}", "\u{4fdd}\u{6301}", "\u{4fdd}\u{6301}"]),
    ("BAR +", ["COMP\u{c1}S +", "COMPASSO +", "MESURE +", "BATTUTA +", "TAKT +", "\u{422}\u{410}\u{41a}\u{422} +", "\u{5c0f}\u{7bc0} +", "\u{5c0f}\u{8282} +"]),
    ("BAR -", ["COMP\u{c1}S -", "COMPASSO -", "MESURE -", "BATTUTA -", "TAKT -", "\u{422}\u{410}\u{41a}\u{422} -", "\u{5c0f}\u{7bc0} -", "\u{5c0f}\u{8282} -"]),
    ("BAND BAR", ["COMP\u{c1}S DE LA BANDA", "COMPASSO DA BANDA", "MESURE DU GROUPE", "BATTUTA DELLA BAND", "TAKT DER BAND", "\u{422}\u{410}\u{41a}\u{422} \u{413}\u{420}\u{423}\u{41f}\u{41f}\u{42b}", "\u{30d0}\u{30f3}\u{30c9}\u{306e}\u{5c0f}\u{7bc0}", "\u{4e50}\u{961f}\u{5c0f}\u{8282}"]),
    ("BAND FOLLOWS THE CLICK", ["LA BANDA SIGUE AL METR\u{d3}NOMO", "A BANDA SEGUE O METR\u{d4}NOMO", "LE GROUPE SUIT LE M\u{c9}TRONOME", "LA BAND SEGUE IL METRONOMO", "DIE BAND FOLGT DEM METRONOM", "\u{413}\u{420}\u{423}\u{41f}\u{41f}\u{410} \u{421}\u{41b}\u{415}\u{414}\u{423}\u{415}\u{422} \u{417}\u{410} \u{41a}\u{41b}\u{418}\u{41a}\u{41e}\u{41c}", "\u{30d0}\u{30f3}\u{30c9}\u{306f}\u{30af}\u{30ea}\u{30c3}\u{30af}\u{306b}\u{5f93}\u{3046}", "\u{4e50}\u{961f}\u{8ddf}\u{968f}\u{8282}\u{62cd}\u{5668}"]),
    ...
    ("STRAIGHT", ["RECTO", "RETO", "BINAIRE", "DRITTO", "GERADE", "\u{420}\u{41e}\u{412}\u{41d}\u{4ae}\u{419}", "\u{30b9}\u{30c8}\u{30ec}\u{30fc}\u{30c8}", "\u{5e73}\u{76f4}"]),
    ("STEPWISE", ["POR GRADOS", "POR GRAUS", "CONJOINT", "PER GRADI", "SCHRITTWEISE", "\u{41f}\u{41b}\u{410}\u{412}\u{41d}\u{41e}", "\u{9806}\u{6b21}\u{9032}\u{884c}", "\u{7ea7}\u{8fdb}"]),
    ("MIXED", ["MIXTO", "MISTO", "MIXTE", "MISTO", "GEMISCHT", "\u{421}\u{41c}\u{415}\u{428}\u{410}\u{41d}\u{41d}\u{41e}", "\u{6df7}\u{5408}", "\u{6df7}\u{5408}"]),
    ("LEAPS", ["CON SALTOS", "COM SALTOS", "AVEC SAUTS", "CON SALTI", "MIT SPR\u{dc}NGEN", "\u{421}\u{41a}\u{410}\u{427}\u{41a}\u{410}\u{41c}\u{418}", "\u{8df3}\u{8e8d}", "\u{8df3}\u{8fdb}"]),
    ...
    ("ARTIFACTS", ["ARTEFACTOS", "ARTEFATOS", "ARTEFACTS", "ARTEFATTI", "ARTEFAKTE", "\u{410}\u{420}\u{422}\u{415}\u{424}\u{410}\u{41a}\u{422}\u{42b}", "\u{30a2}\u{30fc}\u{30c6}\u{30a3}\u{30d5}\u{30a1}\u{30af}\u{30c8}", "\u{6784}\u{4ef6}"]),
    ("METER", ["COMP\u{c1}S", "COMPASSO", "M\u{c9}TRIQUE", "METRO", "TAKTART", "\u{420}\u{410}\u{417}\u{41c}\u{415}\u{420}", "\u{62cd}\u{5b50}", "\u{62cd}\u{53f7}"]),
