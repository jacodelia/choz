...
static TABLE: &[Row] = &[
    ...
    ("Save project\u{2026}", ["Guardar proyecto\u{2026}", "Salvar projeto\u{2026}", "Enregistrer le projet\u{2026}", "Salva progetto\u{2026}", "Projekt speichern\u{2026}", "\u{421}\u{43e}\u{445}\u{440}\u{430}\u{43d}\u{438}\u{442}\u{44c} \u{43f}\u{440}\u{43e}\u{435}\u{43a}\u{442}\u{2026}", "\u{30d7}\u{30ed}\u{30b8}\u{30a7}\u{30af}\u{30c8}\u{3092}\u{4fdd}\u{5b58}\u{2026}", "\u{4fdd}\u{5b58}\u{9879}\u{76ee}\u{2026}"]),
