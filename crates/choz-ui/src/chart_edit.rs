...
// The chord dialogue's species lives in the engine now — the harmoniser
// keeps one as its shape — and the chart is still where it is edited.
pub use choz_engine::artifacts::arranger::spec::ChordSpec;
#[cfg(test)]
pub use choz_engine::artifacts::arranger::spec::{CHORD_ROWS, FAMILIES, TENSIONS};
...
mod tests {
    use super::*;
    use choz_engine::artifacts::arranger::spec::{
        ELEVENTHS, FIFTHS, NINTHS, SEVENTHS, THIRTEENTHS,
    };
