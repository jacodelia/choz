...
pub fn presets(kind: AudioFxKind) -> &'static [FxPreset] {
    ...
    match kind {
        ...
        Reverb => &[
            FxPreset {
                name: "Room",
                values: &[("Room", 0.30), ("Damping", 0.60), ("Wet", 0.25)],
            },
            FxPreset {
                name: "Hall",
                values: &[("Room", 0.80), ("Damping", 0.35), ("Wet", 0.40)],
            },
            FxPreset {
                name: "Plate",
                values: &[("Room", 0.55), ("Damping", 0.15), ("Wet", 0.35)],
            },
            FxPreset {
                name: "Cathedral",
                values: &[("Room", 0.97), ("Damping", 0.20), ("Wet", 0.50)],
            },
        ],
        Compressor => &[
